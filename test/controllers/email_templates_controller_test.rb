...
class EmailTemplatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create email_template" do
    assert_difference('EmailTemplate.count') do
      post email_templates_url, params: { email_template: { footer: @email_template.footer, plain_text: @email_template.plain_text, sender: @email_template.sender, subject: @email_template.subject, text: @email_template.text, user_id: @email_template.user_id } }
    end
  ...
  test "should update email_template" do
    patch email_template_url(@email_template), params: { email_template: { footer: @email_template.footer, plain_text: @email_template.plain_text, sender: @email_template.sender, subject: @email_template.subject, text: @email_template.text, user_id: @email_template.user_id } }
